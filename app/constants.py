...
US_STATE_LIST = [('AK', 'Alaska'), ('AL', 'Alabama'), ('AR', 'Arkansas'), ('AS', 'American Samoa'),
...
VENDOR_TYPES = [('restaurant', "Restaurant"), ('cafe', "Cafe"), ('retail', "Retail"), ('juice', "Juice Bar"),
                ('pub', "Pub"), ('bookstore', "Bookstore"), ('foodtruck', "Food Truck"),
